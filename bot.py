...
def start(message):
    ...
    if str(user_id) == OWNER_ID:
        bot.send_message(user_id, "👑 *Admin Panel *", reply_markup=get_admin_kb(), parse_mode="Markdown")
    else:
...
if __name__ == "__main__":
    threading.Thread(target=run_flask).start() # Server start
    print("🚀 Bot is running lightning fast!")
